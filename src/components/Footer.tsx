export function Footer() {
  const footerLinks = {
    "Возможности": ["Блоки и фигуры", "Умные стрелки", "Шаблоны", "Совместная работа", "Экспорт", "История версий", "Мобильный просмотр"],
    "Продукт": ["Тарифы", "Шаблоны схем", "Интеграции", "История изменений", "Документация", "Скачать", "Попробовать бесплатно"],
    "Компания": ["О нас", "Клиенты", "Карьера", "Новости", "Блог", "Качество", "Бренд"],
    "Ресурсы": ["API для разработчиков", "Статус", "Стартапам", "Сообщить об уязвимости", "DPA", "Конфиденциальность", "Условия"],
