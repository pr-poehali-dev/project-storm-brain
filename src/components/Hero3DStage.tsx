        ...
        <div className="relative z-10 pt-28 flex flex-col">
          ...
          <div className="w-full flex justify-center px-6 mt-16">
            <div className="w-full max-w-4xl">
              ...
              >
                Создавайте блок-схемы и диаграммы любой сложности
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Перетаскивайте блоки, соединяйте стрелками, экспортируйте результат.
                <br />
                Для архитекторов, аналитиков и всей команды.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <button className="text-zinc-300 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm">
                  <span className="text-zinc-500">Новое:</span> Экспорт в PNG, SVG и PDF
